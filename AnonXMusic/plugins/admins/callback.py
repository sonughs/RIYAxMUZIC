...
# Callback state tracking for race condition prevention
checker = {}
upvoters = {}
_callback_locks = {}


async def get_callback_lock(chat_id: int) -> asyncio.Lock:
    """Get or create a lock for a chat to prevent race conditions"""
